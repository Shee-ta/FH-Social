...
import 'package:frontend/screens/main_screen/map/create_event_form_components/study_plan_field.dart';
...
void createEventForm(
  ...
  final createEventController = AppDI.instance.createEventController;
    ...
    builder: (sheetContext) => SafeArea(
      child: Padding(
        ...
        child: CreateEventForm(
          ...
          hasPickedLocation: createEventController.hasPickedLocation,
          setHasPickedLocation: createEventController.setHasPickedLocation,
          setUsingCustomLocation: createEventController.setUsingCustomLocation,
          setPickingLocation: createEventController.setPickingLocation,
          hasNoMap: hasNoMap,
        )
      ),
    ),
...
class CreateEventForm extends StatefulWidget {
  ...
  : eventController = AppDI.instance.eventController,
    draft = AppDI.instance.eventDraft;
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  StudyPlanField(
                    studyPlanController: recommendationController,
                    draft: widget.draft,
                  ),
